  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco-navbar-light ftco-navbar-light-2" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          ...
          <div class="col-md-11 ftco-animate text-center ;">
			<h1 style="color: orange; font-size: 100px;">Credit Card Payment</a></h1>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
			...
			<form action="" method= "POST" class="billing-form bg-light p-3 p-md-5">
				<h3 class="mb-4 billing-heading">Credit Card Payment</h3>
					<div class="row align-items-end">
						<div class="col-md-10">
							<div class="form-group">
								<label for="cardnumber">Card Number</label>
							  <input type="text" name="ccNum" class="form-control" placeholder="5510 9761 2661 8751">
							</div>
						</div>
						...
						<div class="w-100"></div>
							<div class="col-md-10">
								...
								<input type="text" name="ccName" class="form-control" placeholder="e.g Nazir Samaan">
							</div>
						</div>
						...
						<div class="w-100"></div>
							<div class="col-md-5">
								<div class="form-group">
								<label for="towncity">Expired Date</label>
								<input type="date" name="ccEDate" class="form-control" placeholder="01/19">
							</div>
						</div>
						<div class="col-md-5">
							<div class="form-group">
								<label for="postcodezip">Security Code</label>
						  <input type="password" name="ccCode" class="form-control" placeholder="***">
						</div>
						</div>
   ...
   <?php
			...
			$pin=$_POST['ccCode']; 
				...
				$query = "INSERT INTO `debitcard`(`dcID`, `dcNumber`, `dcName`, `dcDate`, `dcCode`) 
				VALUES (NULL, '$num', '$name','$date', '$pin')";
