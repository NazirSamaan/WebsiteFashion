  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco-navbar-light ftco-navbar-light-2" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          ...
          <div class="col-md-11 ftco-animate text-center">
           <h1 style="color:green; font-size: 100px;">Tentang Kami</a></h1>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
		<br><br>
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/Tentangkami.jpg);">
					</div>
					<div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
	          <div class="heading-section-bold mb-5 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Nazir<br> <span>Clothing Store</span></h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
							<p>Nazir Clothing stor ialah destinasi fesyen dalam talian terkemuka di Brunei. CLothing store ditubuhkan pada awal 2018. Menawarkan koleksi meluas lebih 500 jenama dan pereka antarabangsa dan tempatan terkemuka.</p>
						</div>
					</div>
				</div>
			</div>
