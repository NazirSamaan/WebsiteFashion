...
include 'connectionDB.php';
	...
	$query=mysqli_query($connection, "SELECT * FROM Baju WHERE code='$code'");
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/menu-2.jpg" class="image-popup"><img src="<?php echo $Baju['BajuImg']; ?>" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3><?php echo $Baju['BajuName']; ?></h3>
    				<p class="price"><span>BND <?php echo $Baju['BajuPrice'];  ?></span></p>
	
    				<p> <?php echo $Baju['BajuDes']; ?></p>
          	...
          	<?php echo "<p><a href=BajuCartP.php?code=".$Baju['code']." class='btn btn-primary py-3 px-5'>Add to Cart</a></p> ";?>
    			</div>
    		</div>
    	</div>
    </section>
