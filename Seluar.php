		...
		while ($row = mysqli_fetch_assoc($result)){
			...
			echo "
				<div class='col-sm col-md-6 col-lg-3 ftco-animate'>
    				<div class='product'>
						<a href=single_Seluar.php?code=".$row['code']." class='img-prod'><img class='img-fluid' src=".$row['SeluarImg']." alt='Colorlib Template'></a>
							<div class='text py-3 px-3'>
								<h3><a href=>".$row['SeluarName']."</a></h3>
    						<div class='d-flex'>
    							<div class='pricing'>
		    						<p class='price'><span>BND ".$row['SeluarPrice']."</span></p>
		    					</div>
								
							</div>
	    					<hr>
							<p class='bottom-area d-flex'>
    							<a href=SeluarCartP.php?code=".$row['code']." class='add-to-cart' ><span>Add to cart <i class='ion-ios-add ml-1'></i></span></a>	
    						</p>
